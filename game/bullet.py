...
class LineBullet():
    RANGE_BUFFER = 10000
    def __init__(self,start_pos,angle, owner, obtacles, players = None):
        self.angle = angle
    ...
    def caculate_hit_pos(self, obtacles, players):
        ...
        #     hit_pos = liang_barsky((player_x, player_y, obtacle_x + TILE_SIZE, obtacle_y + TILE_SIZE), self.start_pos, (self.end_x, self.end_y))
        #     if hit_pos != None:
        #         possible_hit_pos.append(hit_pos)
